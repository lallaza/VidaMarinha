...
<head>
    ...
    <link rel="stylesheet" href="OLdesign.css">
</head>
<body>
    <nav>
        <section class="menu">
            <ul>
                <li><a href="#IMP">IMPORTÂNCIA</a></li>
                <li><a href="#METAS">METAS</a></li>
                <li><a href="#top"><img class="menu" src="https://uploaddeimagens.com.br/images/004/179/221/full/dolphin.png?1669391579" alt=""></a></li>
                <li><a href="https://brasil.un.org/pt-br/take-action">FAÇA SUA PARTE</a></li>
                <li><a href="#SOBRE_MIM">CRIADORA</a></li>
            </ul> 
        </section>
    </nav>
    <div>
        <section class="inicio"> <br id="top"><br><br><br><br><br><br><br><br><br><br><br><br>
            <div class="vida">
                <p class="vida1"><strong>VIDA NA ÁGUA</strong></p>
                <p class="vida"><strong>E A IMPORTÂNCIA DE SUA PRESERVAÇÃO</strong></p>
            </div>
            <br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br>
        </section>
    </div>
    <div>
            <section class="capa"> <br>
                <h2 id="IMP" class="texto">O <strong>14º</strong> OBJETIVO DE DESENVOLVIMENTO SUSTENTÁVEL DA <strong>ONU</strong></h2>
                <hr> <br><br>
                <iframe class="capa" width="560" height="315" src="https://www.youtube.com/embed/oS4LkYf-yvE" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
              <p class="capa paragraph">A biodiversidade de toda forma de vida da Terra é de uma importância inestimável e, para garantir o equilíbrio ecossistema aquático, 
                é necessário preservá-lo. Apesar da ação humana estar destruindo a vida na hidrosfera, é possível travar e até reverter algumas
                 consquências causadas pelo homem. </p>
                <br>
            <p class="capa paragraph">Conservar e usar de forma sustentável os oceanos, mares e os recursos marinhos é uma meta de desenvolvimento sustentável da Organização 
                 das Nações Unidas, idealizadas nas conferências de ações ambientais. Parte dos objetivos estão projetados para anos futuros, mas muitos deles já deveriam
                 ter sido alcançados e agora, precisam de desempenho para efetivação.
            </p>
        ...
        <section class="inicial">
            ...
            <div class="objetivos-novos">
                <h2 id="METAS" class="texto">14.1 <strong>POLUIÇÃO MARINHA</strong></h2>
                <img class="obj" src="https://uploaddeimagens.com.br/images/004/167/133/full/lixo-plastico-clima_resized_%281%29.jpg?1668711238" alt=""> <br><br>
             <p class="paragraph">A ONU tem o objetivo de prevenir e reduzir de maneira significatica a poluição marinha, sejam detritos marinhos
                 ou poluição por nutrientes, mas especificamente aquela adivinda de atividades terrestres. Isso até o ano de 2025.</p>
             <p  class="paragraph">Considerando que poluição é todo aquele elemento em excesso no ambiente, observa-se que hoje em dia, uma das
    ...
    <div>
        <section class="inicial">
            ...
            <div class="objetivos-novos">
                ...
                <img class="obj"  src="https://uploaddeimagens.com.br/images/004/178/919/full/karthick-krishnakumar-w8zSf9IJBEY-unsplash_%281%29.jpg?1669377137" alt=""> <br>
